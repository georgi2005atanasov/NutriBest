...
export async function allProducts(page, categories = "", price = "", alpha = "", productsView = "", search = "") {
    const query = buildQuery(page, categories, price, alpha, productsView, search);
    const token = getAuthToken();
