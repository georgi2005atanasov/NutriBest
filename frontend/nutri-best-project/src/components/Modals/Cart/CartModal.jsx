...
const CartModal = forwardRef(function CartModal({ }, ref) { //gonna accept sth in the future  
    ...
    return <Modal ref={ref}>
        ...
        >
            ...
            <hr className="m-1" />
            {cart && cart.cartProducts && cart.cartProducts.length > 0 && cart.cartProducts.map(x => <div key={`${x.productId}-${x.flavour}`} className="d-flex flex-md-row flex-column justify-content-between">
